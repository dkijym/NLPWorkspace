...
public class AnnotationTool extends JFrame {
  ...
  public static void main (String[] args) {
  	...
  	Document doc = new Document("This is a document. It has two sentences.");
  	Tokenizer.tokenize (doc, new Span(0, doc.length()));
  	tool.annotateDocument(doc, new Span(0, 27));
  	System.out.println ("First document done.");
  	AnnotationTool tool2 = new AnnotationTool();
  	tool2.addType ('p', new Annotation ("ENAMEX", null, new FeatureSet("TYPE", "PERSON")));
  	tool2.addType ('o', new Annotation ("ENAMEX", null, new FeatureSet("TYPE", "ORGANIZATION")));
  	tool2.addType ('g', new Annotation ("ENAMEX", null, new FeatureSet("TYPE", "GPE")));
  	doc = new Document("This is the second document. It also has two sentences.");
  	Tokenizer.tokenize (doc, new Span(0, doc.length()));
  	tool2.annotateDocument(doc, new Span(0, 35));
