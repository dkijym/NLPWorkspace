...
public class EnglishLex {
   ...
   *  in directory <CODE>directory</CODE>, expands them (generating
   *  inflectional variants), and adds them to the dictionary.
   */

  public static void readLexicon (String directory, String fileName) throws IOException {
  	System.err.println ("Reading lexicon " + fileName);
  	Reader reader = new BufferedReader (
  		new FileReader (directory + File.separatorChar + fileName));
