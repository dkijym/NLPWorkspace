 ...
 * @author shlomo
 * 
 * will replace jung's bipartgraphreader with specialized graph maker and specialized vertices for easier control of graph
 * 
 * based on author Joshua O'Madadhain code.
 *
 */
public class EMTBipartGraphMaker {
    ...
    public EMTBipartGraphMaker(boolean asList, boolean directed, boolean parallel)
    {
        this.asList = asList;
